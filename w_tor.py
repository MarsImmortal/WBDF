...
def elr_dnn_cin(elr_constrains, broad_units, dnn_feature_columns, output_units, dnn_hidden_units=(256, 256),
                ...
                l2_reg_embedding=0.05, l2_reg_dnn=0.001, l2_reg_cin=0.001, seed=1024, dnn_dropout=0.01,
...
test = pd.read_csv('./data_generated/test_redwine.csv')
train = pd.read_csv('./data_gan/redwine_gan.csv')
...
print(custom)
model = keras.models.load_model('adult_model.h5',custom_objects=custom)
